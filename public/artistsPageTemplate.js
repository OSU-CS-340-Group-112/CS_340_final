...
templates['artistsPage'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <tr>\n                <td>"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"artistID") || (depth0 != null ? lookupProperty(depth0,"artistID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"artistID","hash":{},"data":data,"loc":{"start":{"line":30,"column":50},"end":{"line":30,"column":62}}}) : helper)))
    + ")\">Delete</button></td>\n            </tr>\n";
  ...
  return "<div class=\"container\">\n    <center>\n    <div id=\"landing-pg\">\n    <h1>Artists</h1>\n    <h3>This page allows access to the Artists database entity.</h3>\n    </center>\n</div>\n\n<!--\n<div class=\"form-group\">\n    <center>\n    <label for=\"exampleArtist\"> <h4>Add a new Artist</h4></label>\n    <input type=\"name\" class=\"form-control\" id=\"exampleArtist\" placeholder=\"Enter artist\">\n    <button class=\"btn btn-dark\">Add</button>\n    </center>\n</div>\n-->\n    <table>\n        <thead>\n            <th>ArtistID</th>\n            <th>Artist Name</th>\n            <th>Record Label</th>\n        </thead>\n        <tbody>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"artist") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":25,"column":12},"end":{"line":32,"column":21}}})) != null ? stack1 : "")
