...
templates['songsPage'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <option value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"albumID") || (depth0 != null ? lookupProperty(depth0,"albumID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"albumID","hash":{},"data":data,"loc":{"start":{"line":40,"column":23},"end":{"line":40,"column":34}}}) : helper)))
    + "\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"albumTitle") || (depth0 != null ? lookupProperty(depth0,"albumTitle") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"albumTitle","hash":{},"data":data,"loc":{"start":{"line":40,"column":36},"end":{"line":40,"column":50}}}) : helper)))
    + "</option>\n";
  ...
  return "<script src=\"deletesong.js\"></script>\n\n\n<div class=\"container\">\n    <center>\n    <div id=\"landing-pg\">\n    <h1>Songs</h1>\n    <h3>This page allows access to the Songs in the database.</h3>\n    </center>\n</div>\n    <table>\n        <thead>\n            <th>SongID</th>\n            <th>SongTitle</th>\n            <th>alID</th>\n            <th>Runtime</th>\n            <th>Writing Credit</th>\n        </thead>\n        <tbody>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"song") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":20,"column":12},"end":{"line":30,"column":21}}})) != null ? stack1 : "")
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"albums") : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":39,"column":8},"end":{"line":41,"column":17}}})) != null ? stack1 : "")
